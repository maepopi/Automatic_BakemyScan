...
%blenderPath% -P %multipleTexturesScript% -- %texturePath% %multitextures_process_output_path% %name% %object_extension% %objectPath%
REM           1    2                       3          4                5                          6              7              8                9

REM :image_extension_done
REM echo image_extension is %image_extension%


REM REM BASIC VARIABLES

REM set processInPath=%1\%name%.%object_extension%


REM REM PREPARATION OF THE OBJECT PRIOR TO DECIMATION
REM mkdir %1\Preprocess

REM set preprocess_output_path=%1\Preprocess

REM %blenderPath% -b -P %preProcessScriptPath% -- %inputFullPath% %processInPath% %object_extension% %image_extension% %preprocess_output_path% %name%
