...
# #        #--------------------------
        ...
        # export_folderpath= os.path.join(itemfolderpath, "GLB")
        ...
        # export_filepath = os.path.join(export_folderpath, itemname)
...
def test():
#Penser a changer l'index du parametre pour la version finale, quand on aura rajouté le "-b" à la commande
    rootfolder= os.path.join(sys.argv[4])
